...
class Agent:
    def __init__(self, n_actions, input_dims, fc1_dims = 256, fc2_dims = 256, gamma=0.99, alpha = 0.0003, gae_lambda= 0.95,
        ...
        self.actor = ActorNetwork(n_actions, input_dims, fc1_dims=fc1_dims, fc2_dims=fc2_dims, alpha = alpha)
        self.critic = CriticNetwork(input_dims,fc1_dims=fc1_dims, fc2_dims=fc2_dims, alpha = alpha)
